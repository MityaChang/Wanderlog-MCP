...
local context. Use wanderlog_annotate_place, wanderlog_edit_note,
wanderlog_remove_note, wanderlog_list_expenses, wanderlog_edit_expense,
wanderlog_remove_expense, wanderlog_update_trip_dates, and
wanderlog_rename_day only when the user asks to change an existing live
Wanderlog trip. Add lodging with wanderlog_add_hotel when requested. Add a
...
The add-place, add-hotel, add-checklist, add-expense, draft update, draft
delete, and draft export tools operate on local drafts stored in a user-local
JSON file. Local drafts are not live Wanderlog writes. Use
wanderlog_list_drafts to inspect the current draft state and
