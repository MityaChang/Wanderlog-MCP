...
| `wanderlog_add_section`               | Adds a new custom section to a live Wanderlog trip itinerary.     |
| `wanderlog_update_section`            | Renames the heading of a custom section in a live Wanderlog trip. |
| `wanderlog_delete_section`            | Permanently deletes a custom section and all its blocks.          |
